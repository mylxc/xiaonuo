 ...
 */
package com.jackli.web.core.provider.sys.position;
...
/*import com.jackli.sys.feign.SysPositionFeign;
import com.jackli.sys.modular.position.provider.SysPositionApiProvider;*/
...
@RestController
public class SysPositionFeignProvider  {
