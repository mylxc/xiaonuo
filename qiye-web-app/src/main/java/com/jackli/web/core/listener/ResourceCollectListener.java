 ...
 */
package com.jackli.web.core.listener;
                        ...
                        .forEach((key, value) -> {
                            ...
                            if(ObjectUtil.isNotEmpty(saCheckPermission)) {
                                ...
                                if (patternsCondition != null) {
                                    ...
                                    permissionResult.add(patternsCondition.getPatterns().iterator().next().substring(11) +
                                            StrUtil.BRACKET_START + apiName + StrUtil.BRACKET_END);
                                }
                            }
                        }));
