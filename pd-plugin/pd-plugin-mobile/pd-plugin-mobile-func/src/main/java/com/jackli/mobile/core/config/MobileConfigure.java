 ...
 */
package com.jackli.mobile.core.config;
    ...
    public Docket mobileDocApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfoBuilder()
                        ...
                        .contact(new Contact("JACKLI_TEAM","https://www.jcxxdd.com", "767076381@qq.com"))
                        .version("2.0.0")
                        .build())
                ...
                .apis(RequestHandlerSelectors.basePackage("com.jackli.mobile"))
