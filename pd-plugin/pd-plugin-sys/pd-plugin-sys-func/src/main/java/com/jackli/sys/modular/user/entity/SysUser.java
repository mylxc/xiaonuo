 ...
 */
package com.jackli.sys.modular.user.entity;
...
import com.jackli.common.handler.CommonSm4CbcTypeHandler;
...
public class SysUser extends CommonEntity implements TransPojo {
    ...
    @ApiModelProperty(value = "卡号", position = 27)
    ...
    @ApiModelProperty(value = "职位名称", position = 50)
    @TableField(exist = false)
