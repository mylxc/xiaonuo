 ...
 */
package com.jackli.sys.modular.user.service;
...
import com.jackli.sys.modular.user.result.SysUserMessageDetailResult;
import com.jackli.sys.modular.user.result.SysUserMessageResult;
import com.jackli.sys.modular.user.result.SysUserPicValidCodeResult;
import com.jackli.sys.modular.user.result.SysUserPositionResult;
...
public interface SysUserService extends IService<SysUser> {
     ...
     * @date 2022/7/5 18:22
     **/
    String resetPassword(SysUserIdParam sysUserIdParam);
