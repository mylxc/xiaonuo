 ...
 */
package com.jackli.web.core.provider.sys.user;
...
/*import com.jackli.sys.feign.SysUserFeign;
import com.jackli.sys.modular.user.provider.SysUserApiProvider;*/
...
@RestController
public class SysUserFeignProvider{
