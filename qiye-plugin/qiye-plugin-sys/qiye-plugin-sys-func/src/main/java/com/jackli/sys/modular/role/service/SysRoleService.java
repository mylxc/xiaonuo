 ...
 */
package com.jackli.sys.modular.role.service;
...
public interface SysRoleService extends IService<SysRole> {
     ...
     **/
    void disableRole(SysRoleIdParam sysRoleIdParam);
    /**
     * 启用角色
     *
     * @author lijinchang
    ...
    void enableRole(SysRoleIdParam sysRoleIdParam);
    /**
     * 获取角色分页
     *
     * @author lijinchang
