 ...
 */
package com.jackli.sys.modular.role.controller;
...
public class SysRoleController {
    ...
    public CommonResult<List<SysRole>> list() {
        ...
        queryWrapper.lambda().eq(SysRole::getRoleStatus, SysUserStatusEnum.ENABLE.getValue());
        return CommonResult.data(sysRoleService.list(queryWrapper));
    }
    ...
    @ApiOperation("禁用角色")
    @CommonLog("禁用角色")
    @PostMapping("/sys/role/disableRole")
    public CommonResult<String> disableRole(@RequestBody SysRoleIdParam sysRoleIdParam) {
        sysRoleService.disableRole(sysRoleIdParam);
    ...
    @ApiOperation("启用角色")
    @CommonLog("启用角色")
    @PostMapping("/sys/role/enableRole")
    public CommonResult<String> enableRole(@RequestBody @Valid SysRoleIdParam sysRoleIdParam) {
        sysRoleService.enableRole(sysRoleIdParam);
        return CommonResult.ok();
    }
    /**
     * 添加角色
     ...
     *
     * @author tianhengmiao
     * @date 2022/10/24 09:32
     */
    @ApiOperationSupport(order = 20)
    @ApiOperation("获取角色总数量")
    @GetMapping("/sys/role/roleCount")
    public CommonResult<Long> roleCount() {
        return CommonResult.data(sysRoleService.roleCount());
    }
     ...
     *
     * @author tianhengmiao
     * @date 2022/10/24 09:36
     */
    @ApiOperationSupport(order = 21)
    @ApiOperation("获取角色包含用户")
    @GetMapping("/sys/role/roleContains")
    public CommonResult<List<SysRoleVo>> roleContains() {
        return CommonResult.data(sysRoleService.roleContains());
    }
}
