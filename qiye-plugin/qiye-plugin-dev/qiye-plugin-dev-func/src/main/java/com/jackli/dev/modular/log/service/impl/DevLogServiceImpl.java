 ...
 */
package com.jackli.dev.modular.log.service.impl;
...
import com.jackli.dev.modular.log.mapper.DevLogMapper;
...
public class DevLogServiceImpl extends ServiceImpl<DevLogMapper, DevLog> implements DevLogService {
    ...
    @Override
    public List<DevLogCaculateDataResult> selectCaculateLogs() {
        return this.baseMapper.selectLogCaculate();
    }
