 ...
 */
package com.jackli.dev.core.aop;
...
import com.jackli.dev.modular.log.util.DevLogUtil;
...
public class ConsoleLogAop {
     ...
     */
    @Pointcut("@annotation(com.jackli.common.annotation.ConsoleLog)")
    ...
    public void doAfterReturning(JoinPoint joinPoint, Object result) {
        ...
        // 异步记录日志
        DevLogUtil.executeConsoleOperationLog(consoleLog, userName, joinPoint, JSONUtil.toJsonStr(result));
    }
    ...
    public void doAfterThrowing(JoinPoint joinPoint, Exception exception) {
        ...
        //异步记录日志
        DevLogUtil.executeConsoleExceptionLog(consoleLog, userName, joinPoint, exception);
    }
}
